...
export default function Home({ }: Props) {
  ...
  const ourAwesomeWorkCardImg1: any = useRef(null);
  const ourAwesomeWorkCardImg2: any = useRef(null);
  const ourAwesomeWorkCardImg3: any = useRef(null);
  const ourAwesomeWorkCardImg4: any = useRef(null);
  const ourAwesomeWorkCardImg5: any = useRef(null);
  const ourAwesomeWorkCardImg6: any = useRef(null);
  const ourAwesomeWorkCardImg7: any = useRef(null);
  const ourAwesomeWorkCardImg8: any = useRef(null);
